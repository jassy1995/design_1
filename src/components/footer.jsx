        ...
        <div className='flex flex-col space-y-4 bg-[rgb(12,21,36)] px-[60px] pt-48 pb-5 -mt-[180px]'>
            ...
            <div className="flex space-x-8">
                <div className="flex space-x-1">
                    <span><i className="fa fa-location-dot"></i></span>
                ...
                <div className='flex flex-col space-y-3 w-[20%]'>
                    <div className='flex space-x-3'>
                        <span><i className="fa fa-phone-volume"></i></span>
                ...
                <div className="flex space-x-3  w-[20%]">
                    <span className="border border-slate-300 rounded-full h-6 w-6 cursor-pointer flex justify-center items-center"><i className="fa-brands fa-facebook-f"></i></span>
                    <span className="border border-slate-300 rounded-full h-6 w-6 cursor-pointer flex justify-center items-center"><i className="fa-brands fa-twitter"></i></span>
                    <span className="border border-slate-300 rounded-full h-6 w-6 cursor-pointer flex justify-center items-center"><i className="fa-brands fa-instagram"></i></span>
                </div>
            </div>
